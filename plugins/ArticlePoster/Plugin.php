...
class ArticlePoster_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function config(Typecho_Widget_Helper_Form $form)
    {
        ...
        $form->addInput($qq);
        $button = new Typecho_Widget_Helper_Form_Element_Textarea('button', null, '<a class="btn btn-grey article-poster-button">文章海报</a>', '自定义按钮样式', '根据自己模板的按钮样式来自定义分享按钮的样式，在class里面加入<b style="color: #ff0000;">article-poster-button</b>即可使用');
